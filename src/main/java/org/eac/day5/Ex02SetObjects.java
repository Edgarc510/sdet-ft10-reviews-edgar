...
public class Ex02SetObjects {
    public static void main(String[] args) {
        ...
        Set<String> set1 = new HashSet<>(); // random order, no duplicates
        set1.add(null);
        ...
        Set<String> set2 = new LinkedHashSet<>(); // maintains insertion order, no duplicates
        set2.add(null);
        ...
        Set<String> set3 = new TreeSet<>(); // maintains natural order (sorted) -> String types: lexicographically (ascii order), no nulls, no duplicates
        ...
        set3.add("Ahello world");
        set3.add("Bhello world");
        set3.add("Chello world");
