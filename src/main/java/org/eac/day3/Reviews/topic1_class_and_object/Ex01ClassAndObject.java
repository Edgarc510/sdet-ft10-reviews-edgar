...
public class Ex01ClassAndObject {
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(book1.publisher); // an object belongs to the class, so all objects share the same static members.
        // This allows static members to be access via object references, but it is not recommended
